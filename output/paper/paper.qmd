...
Gulou, Qinhuai, Xuanwu, Jianye, Qixia, Yuhuatai districts are considered as inner city while Pukou, Jiangning, Lishui, Gaochun, Liuhe districts are considered as suburban areas of Nanjing.
...
#| message: false
#| warning: false
#| fig-cap: Proportion of house with difference decoration status and facing south in 11 districts
#| fig-subcap: 
#|   - "South-facing"
#|   - "Decoration"
#| layout-ncol: 2
...
district area difference, population difference, other spatial data for detailed analysis.
...
web scrapping maximun 100 pages
